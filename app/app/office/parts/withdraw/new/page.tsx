...
function NewWithdrawalContent() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title={editDocId ? "แก้ไขใบเบิกอะไหล่" : "บันทึกการเบิกอะไหล่"}
        description={
          editDocId
            ? "แก้ไขรายการเบิกหรือเพิ่มอะไหล่ — ระบบตัด/คืนสต็อกเฉพาะส่วนที่เปลี่ยนแปลง"
            : "หักยอดสต็อกออกจากคลังเพื่อนำไปใช้งานในใบงานหรือบิลขาย — ถ้ามีใบเบิกเดิมของงานเดียวกัน ระบบจะเปิดใบเดิมให้แก้ไข"
        }
      />
